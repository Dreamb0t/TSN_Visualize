...
class Stream:
    ...
    Attributes:
        ...
        source_node (str): Identifier of the source node (end system) of the stream.
        destination_node (str): Identifier of the destination node (end system) of the stream.
